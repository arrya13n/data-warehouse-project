/*
  Script Purpose:
      This script runs a quality check on silver schema in various type such as data consistency, standardization and accuracy.It checks several factors such as
        - Null or duplcate primary keys
        ...
        - invalid datatypes
   When to use:
        - Run this after loading data in silver layer
*/
